...
@WebServlet(name = "OfrendaServletJNI", urlPatterns = {"/ofrendaJNI"})
public class OfrendaServletJNI extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.getRequestDispatcher("/registrarOfrendaJNI.jsp").forward(request, response);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if ("registrar".equalsIgnoreCase(action)) {
            try {
                ...
                int idMinisterio = 2; // Establece directamente el ID 2
