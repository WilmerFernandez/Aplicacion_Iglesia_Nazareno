...
@WebServlet(name = "OfrendaServletMNI", urlPatterns = {"/ofrendaMNI"})
public class OfrendaServletMNI extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.getRequestDispatcher("/registrarOfrendaMNI.jsp").forward(request, response);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if ("registrar".equalsIgnoreCase(action)) {
            try {
                ...
                int idMinisterio = 3; // Establece directamente el ID 3
