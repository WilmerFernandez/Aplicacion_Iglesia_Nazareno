...
<head>
    ...
    <title>Lista de Asistencias - Ministerio </title>
    <style>
        body {
...
<body>
    <h1>Lista de Asistencias Juventud Nazarena Internacional  </h1>

    <p>Aquí puedes ver y filtrar las asistencias registradas de la Juventud Nazarena Internacional</p>

    <form action="listarAsistencias" method="get">
        <input type="hidden" name="idMinisterio" value="${idMinisterio != null ? idMinisterio : 2}"/>
