...
<head>
    <meta charset="UTF-8" />
    <title>Registrar Ofrenda MNI</title> <%-- Título específico para MNI --%>
    <style>
...
<body>
    <div class="form-container">
        ...
        <form action="${pageContext.request.contextPath}/ofrenda" method="post">
            ...
            <%-- CAMBIOS CLAVE PARA OFRENDA MNI: --%>
            <input type="hidden" name="idMinisterioForm" value="3" /> <%-- ID para MNI --%>
            <input type="hidden" name="jspName" value="registrarOfrendaMNI" /> <%-- El nombre del JSP --%>
            <%-- FIN CAMBIOS CLAVE --%>
