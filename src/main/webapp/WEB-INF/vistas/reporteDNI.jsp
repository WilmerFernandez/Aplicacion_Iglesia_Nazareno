...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Reporte Financiero: DNI</title>
        ...
        <div class="container mt-5">
            ...
            <div class="export-buttons">
                <form action="${pageContext.request.contextPath}/exportarReporteMinisterioExcel" method="get" style="display: inline;">
                    <input type="hidden" name="idMinisterio" value="4"> <%-- ID 4 para DNI --%>
                    <button type="submit" class="btn btn-info">Exportar Reporte DNI Excel</button>
                </form>
                <form action="${pageContext.request.contextPath}/exportarReporteMinisterioPdf" method="get" style="display: inline;">
                    <input type="hidden" name="idMinisterio" value="4"> <%-- ID 4 para DNI --%>
                    <button type="submit" class="btn btn-warning">Exportar Reporte DNI PDF</button>
                </form>
            </div>
