...
<body>
    <div class="form-container">
        ...
        <form action="${pageContext.request.contextPath}/salida" method="post">
            ...
            <input type="hidden" name="idMinisterioForm" value="1" /> <%-- Este debe ser el ID para Salida General (Iglesia) --%>
            <input type="hidden" name="jspName" value="registrarSalida" /> <%-- Este debe coincidir con el nombre del JSP (registrarSalida.jsp) --%>
