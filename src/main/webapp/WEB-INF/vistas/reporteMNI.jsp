...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Reporte Financiero: MNI</title>
        ...
        <div class="container mt-5">
            ...
            <div class="export-buttons">
                <form action="${pageContext.request.contextPath}/exportarReporteMinisterioExcel" method="get" style="display: inline;">
                    <input type="hidden" name="idMinisterio" value="3"> <%-- ID 3 para MNI --%>
                    <button type="submit" class="btn btn-info">Exportar Reporte MNI Excel</button>
                </form>
                <form action="${pageContext.request.contextPath}/exportarReporteMinisterioPdf" method="get" style="display: inline;">
                    <input type="hidden" name="idMinisterio" value="3"> <%-- ID 3 para MNI --%>
                    <button type="submit" class="btn btn-warning">Exportar Reporte MNI PDF</button>
                </form>
            </div>
