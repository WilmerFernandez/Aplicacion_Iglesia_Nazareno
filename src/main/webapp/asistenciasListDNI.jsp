...
<body>
    <h1>Lista de Asistencias de DNI </h1>

    <p>Aquí puedes ver y filtrar las asistencias de Discipulado Nazareno Internacional</p>

    <form action="listarAsistencias" method="get">
        <input type="hidden" name="idMinisterio" value="${idMinisterio != null ? idMinisterio : 4}"/>
